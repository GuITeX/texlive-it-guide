...
predefinita di \dirname{TEXDIR} è \dirname{/usr/local/texlive/2011} sotto
Unix e |%SystemDrive%\texlive\2011| sotto Windows.
...
Se avete installato il pacchetto \filename{xetex} su un sistema
...
quando il pacchetto \pkgname{xetex} è installato (sia durante
...
\file{.../2011/texmf.cnf}. Se dovete apportare delle modifiche ai valori
predefiniti (di norma non è necessario), questo è il posto in cui
piazzarle. Il file di configurazione principale è
\file{.../2011/texmf/web2c/texmf.cnf}. Non dovreste modificare
...
L'edizione del 2011 ha visto relativamente poche modifiche.
