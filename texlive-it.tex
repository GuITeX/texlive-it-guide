...
% arara: pdflatex
% arara: showfile
%CM Ho commentato con %CMerr, %CMwarn e semplicemente %CM rispettivamente 
%CM le righe che, a mio parere, sono errate, suonano male e le mie note.
%CM Subito dopo le righe commentate, ho inserito la mia versione.
%CM
...
\begin{description}
  ...
  \item[percorso home dell'utente] (\texttt{\$HOME} o
      \texttt{\%USERPROFILE\%})
    \begin{ttdescription}
      \item[.texlive2016] Dati privati generati e di configurazione relativi ad
        un'edizione precedente.
      \item[.texlive2017] Dati privati generati e di configurazione relativi
...
creati per tutti gli utenti e l'ambiente di sistema è modificato. 
...
sul collegamento che volete eseguire, solitamente appare anche la voce 
``Esegui
come amministratore''.
...
dato profilo; nuovo comando \code{P} per salvare esplicitamente un profilo;
...
\emph{\TL{} non è perfetto!} (E mai lo sarà). Intendiamo continuare a
fornire nuove versioni e vorremmo fornire ulteriore materiale d'aiuto, più
...
lavoro è fatto completamente da volontari nel loro
tempo libero e quindi c'è sempre molto da fare. Visitate il sito
